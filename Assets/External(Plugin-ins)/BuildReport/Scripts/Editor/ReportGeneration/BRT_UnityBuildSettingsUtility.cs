...
public static class UnityBuildSettingsUtility
{
	...
	public static void PopulateGeneralSettings(UnityBuildSettings settings)
	{
		...
		settings.StackTraceForError = PlayerSettings.GetStackTraceLogType(UnityEngine.LogType.Error).ToString();
		settings.StackTraceForAssert = PlayerSettings.GetStackTraceLogType(UnityEngine.LogType.Assert).ToString();
		settings.StackTraceForWarning = PlayerSettings.GetStackTraceLogType(UnityEngine.LogType.Warning).ToString();
		settings.StackTraceForLog = PlayerSettings.GetStackTraceLogType(UnityEngine.LogType.Log).ToString();
		settings.StackTraceForException = PlayerSettings.GetStackTraceLogType(UnityEngine.LogType.Exception).ToString();
#endif
