...
public class SVBoxSlider : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        if (Application.isPlaying && picker != null)
        {
            ...
            slider.onValueBeginChanged.AddListener((a, b) =>
            {
                picker.onValueBeginChanged.Invoke(picker.CurrentColor);
            });
            slider.onValueEndChanged.AddListener((a, b) =>
            {
                picker.onValueEndChanged.Invoke(picker.CurrentColor);
            });
    ...
    private void OnDisable()
    {
        if (picker != null)
        {
            ...
            slider.onValueBeginChanged.RemoveAllListeners();
            slider.onValueEndChanged.RemoveAllListeners();
