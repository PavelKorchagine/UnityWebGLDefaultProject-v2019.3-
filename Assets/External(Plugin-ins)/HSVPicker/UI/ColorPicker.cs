...
public class ColorPicker : MonoBehaviour
{
    ...
    public ColorChangedBeginEvent onValueBeginChanged = new ColorChangedBeginEvent();
    public ColorChangedEndEvent onValueEndChanged = new ColorChangedEndEvent();
    ...
    private bool eventTriggerInited = false;
    private void InitEventTrigger()
    {
        if (eventTriggerInited) return;
