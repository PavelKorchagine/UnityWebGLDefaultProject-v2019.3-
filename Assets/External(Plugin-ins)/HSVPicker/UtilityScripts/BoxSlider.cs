...
namespace UnityEngine.UI
{
	...
	public class BoxSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
	{
        ...
        [Serializable]
        public class BoxSliderBeginEvent : UnityEvent<float, float> { }

        [Serializable]
        public class BoxSliderEndEvent : UnityEvent<float, float> { }
        ...
        [SerializeField]
        private BoxSliderBeginEvent m_OnValueBeginChanged = new BoxSliderBeginEvent();
        public BoxSliderBeginEvent onValueBeginChanged { get { return m_OnValueBeginChanged; } set { m_OnValueBeginChanged = value; } }

        [SerializeField]
        private BoxSliderEndEvent m_OnValueEndChanged = new BoxSliderEndEvent();
        public BoxSliderEndEvent onValueEndChanged { get { return m_OnValueEndChanged; } set { m_OnValueEndChanged = value; } }
		...
		public override void OnPointerDown(PointerEventData eventData)
		{
            ...
            m_OnValueBeginChanged.Invoke(0, 0);
        ...
        public override void OnPointerUp(PointerEventData eventData)
        {
            ...
            m_OnValueEndChanged.Invoke(0, 0);
        }
